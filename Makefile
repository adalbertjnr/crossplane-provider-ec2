# ====================================================================================
# Setup Project
PROJECT_NAME := provider-customcomputeprovider
...
IMAGES = provider-customcomputeprovider
...
XPKGS = provider-customcomputeprovider
-include build/makelib/xpkg.mk

# NOTE(hasheddan): we force image building to happen prior to xpkg build so that
# we ensure image is present in daemon.
xpkg.build.provider-customcomputeprovider: do.build.images
...
dev: $(KIND) $(KUBECTL)
	...
	@$(INFO) Installing Provider CustomComputeProvider CRDs
	@$(KUBECTL) apply -R -f package/crds
	@$(INFO) Starting Provider CustomComputeProvider controllers
...
# This target prepares repo for your provider by replacing all "customcomputeprovider"
